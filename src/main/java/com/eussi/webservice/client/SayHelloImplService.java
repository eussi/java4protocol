 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://client.webservice.eussi.com/", wsdlLocation = "http://localhost:8888/sayhello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://client.webservice.eussi.com/", "SayHelloImplService");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://client.webservice.eussi.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://client.webservice.eussi.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
